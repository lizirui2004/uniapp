<template>
  <view class="page">
    ...
    <wd-swiper class="advertise" :list="advertise_list" autoplay v-model:current="current" @click="handleClick" style="margin-top: 20px;"></wd-swiper>
    <wd-grid clickable :column="6" style="margin-top: 20px;">
    ...
    <view style="width: 90vw; margin-left: 5vw; margin-right: 5vw; ">
      <text style="font-size: 13px;">认领种植购</text>
      <wd-grid :column="4" >
        <wd-grid-item icon="/static/icon/claim.png" text="土地认领" />
        <wd-grid-item icon="/static/icon/resorce.png" text="果园认领" :icon-style="{ width: '50px', height: '50px', 'object-fit': 'contain' }"/>
        <wd-grid-item icon="/static/icon/consulting.png" text="咨询动态" />
        <wd-grid-item icon="/static/icon/myclaim.png" text="我的认领" />
      </wd-grid>
    </view>
